...
{
    // Qui puoi personalizzare la formattazione come preferisci:
    // - utilizzare un background color solido
    // - utilizzare classi CSS (se usi un framework come Bootstrap)
    // - aggiungere icone, ecc.

    // In questo esempio restituiamo una <div> con stile inline
    // che usa il colore passato come sfondo.
